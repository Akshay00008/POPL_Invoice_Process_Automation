        ...
        response = client.chat.completions.create(
            ...
            },
            {
                ...
                "content": [
                    ...
                    "(Goods/Services Details: description: Exact item text as it appears. Ensure the correct extraction of the item description without altering or skipping any characters.quantity: Numeric value extracted from any of the following aliases: 'Quantity', 'Qty', 'QTY', 'QUANTITY'. This value can include decimals (e.g., 464.00) and should not be confused with unit price. Ensure that the correct number is extracted from the column names or labels provided in aliases, and make sure it corresponds accurately to the description. Avoid interpreting decimal values as unit prices.unit_price: Numeric value extracted from any of the following aliases: '@ price', '@price', 'Unit Price', 'Unity Price', 'Rate', 'rate'. Ensure that the extracted unit price is accurate, and take care to correctly interpret numbers as they are written (e.g., ensure that '6' is not confused with '5', '9' is not interpreted as '0', '4' is not interpreted as '1', etc.)."},
