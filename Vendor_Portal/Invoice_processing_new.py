        ...
        response = client.chat.completions.create(
            ...
            },
            {
                ...
                "content": [
                    ...
                    {"type": "text", "text": "Goods/Services Details (Goods/Services Details: List of objects with: - description: Exact item text  - quantity: Numeric value (also referred to by aliases such as Quantity, Qty, QTY, QUANTITY). Ensure that numbers are extracted as they are written. Do not confuse similar-looking characters. For example: '6' should not be interpreted as '5', '9' should not be interpreted as '0', '4' should not be interpreted as '1', etc. This field accepts values corresponding to any of these aliases and should be interpreted correctly based on the provided input ,Quantity will never be 0.- unit_price: Numeric value (aliases : @ price, @price, Unit Price, unity price, Rate, rate) Ensure that numbers are extracted as they are written. Do not confuse similar-looking characters. For example: '6' should not be interpreted as '5', '9' should not be interpreted as '0', '4' should not be interpreted as '1', etc.) "},
